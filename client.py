...
while True:
    # Processar eventos primeiro para capturar KEYDOWN (espaço)
    ...
    # INPUT local -> servidor (teclas de movimento contínuas)
    ...
    r1 = s1.get_rect(center=(LARGURA_TELA * 0.84, 90))
    r2 = s2.get_rect(center=(LARGURA_TELA * 0.16, 90))
